...
contains
  ...
  subroutine oblate_smn_batch_r16_acc(m, n, c, n_eta, eta, normalize, value, derivative, naccs_out, status) bind(C, name="oblate_smn_batch_r16_acc")
    integer(c_int), value, intent(in) :: m, n, n_eta, normalize
    real(c_double), value, intent(in) :: c
    real(c_double), intent(in) :: eta(*)
    real(c_double), intent(out) :: value(*), derivative(*)
  ...
  end subroutine oblate_smn_batch_r16_acc

  subroutine oblate_rmn_batch_r16_acc(m, n, c, n_x, xvec, kind, value_re, value_im, deriv_re, deriv_im, naccr_out, status) bind(C, name="oblate_rmn_batch_r16_acc")
    integer(c_int), value, intent(in) :: m, n, n_x, kind
    real(c_double), value, intent(in) :: c
    real(c_double), intent(in) :: xvec(*)
    real(c_double), intent(out) :: value_re(*), value_im(*), deriv_re(*), deriv_im(*)
  ...
  end subroutine oblate_rmn_batch_r16_acc

  subroutine oblate_eigenvalue_r16(m, n, c, eig, status) bind(C, name="oblate_eigenvalue_r16")
  ...
  end subroutine oblate_eigenvalue_r16
